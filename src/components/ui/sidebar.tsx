        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ? "w-[var(--sidebar-width)] group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))]"
              : "w-[var(--sidebar-width)] group-data-[collapsible=icon]:w-[--sidebar-width-icon]"
          )}
        />
        <div
          className={cn(
